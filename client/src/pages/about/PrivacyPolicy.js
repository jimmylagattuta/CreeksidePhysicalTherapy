...
const PrivacyPolicy = () => {
    const documentUrl = process.env.NODE_ENV === 'production' ? 'https://creekside-physical-therapy-3c43d5dad481.herokuapp.com/UnityMSKPrivacyPolicy.docx' : 'http://localhost:3001/UnityMSKPrivacyPolicy.docx';
