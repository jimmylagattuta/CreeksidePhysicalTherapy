...
const PrivacyPolicy = () => {
    const documentUrl = process.env.NODE_ENV === 'production' ? 'https://www.creeksidephysicaltherapy.com/UnityMSKPrivacyPolicy.docx' : 'http://localhost:3001/UnityMSKPrivacyPolicy.docx';
