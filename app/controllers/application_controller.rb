class ApplicationController < ActionController::Base
  ...
  def cors_set_access_control_headers
    allowed_origins = ['localhost:3001', 'https://www.creekside-physical-therapy-3c43d5dad481.herokuapp.com', 'https://creekside-physical-therapy-3c43d5dad481.herokuapp.com'] # Add any additional allowed origins as needed
